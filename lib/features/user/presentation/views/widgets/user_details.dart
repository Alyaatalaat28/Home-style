          ...
          InkWell(
            onTap: (){
              showDialog(context: context, builder: ((context) =>const CustomAlertDialog(
                  title:'help & support' ,
                  content:'For further information about this app CONTACT: alyaatalaat205@gmail.com' ,
                )  ));
            },
            child: ListTile(
            leading:const Icon(
